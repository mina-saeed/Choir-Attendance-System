				...
				<div class="inner">
					<div class="grid-menu clearfix">
						...
						<form action="engine.php" method="post">
							...
							<div class="row">
								<div class="col-md-4"></div>
								<div class="col-md-4"><div class="inner" align="center"><input type="text" name="title" value=""  placeholder="Post Title" /></div></div>
								<div class="col-md-4"></div>
							</div>
							<br><br><br>
							<div class="row">
							...
							<div class="row">
								<div class="col-md-4"></div>
								<div class="col-md-4"><div class="inner" align="center"> <textarea id="message" placeholder="Message" name="message"></textarea></div></div>
								<div class="col-md-4"></div>
							</div>
							<br>
							<br>
